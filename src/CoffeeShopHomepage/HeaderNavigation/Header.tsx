        ...
        <AppBar position="static" sx={{ backgroundColor: '#3e2016', color: 'white' }}>
          <Container maxWidth="xl">
            <Toolbar disableGutters>
              ...
              <TextField size='small' type='text' placeholder='Search Coffee' style={{ height: 'auto', width: '35%', borderRadius: '5px', marginLeft: '18%', backgroundColor: 'wheat', borderColor: 'wheat' }} className='textfieldsearch'/>
          ...
          */}
              <Box sx={{ flexGrow: 0 }}>
                ...
                >
                  ...
                  <Link to='/Profile' style={{ textDecoration: 'none',color: '#3e2016'}}><MenuItem onClick={handleCloseUserMenu}>Profile</MenuItem></Link>
